  ...
  return (
    ...
    >
      <div className="space-y-8">
        <div className="rounded-3xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-8 shadow-2xl">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex-1">
              <div className="relative">
                <input
                  ...
                  className="h-12 w-full rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 pl-12 pr-4 text-sm text-gray-900 dark:text-white outline-none transition focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20"
                  placeholder="Search questions..."
                />
                <svg className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-500 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="group flex items-center gap-2 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-4 py-2 text-sm font-semibold text-gray-900 dark:text-white transition-all hover:border-yellow-400 hover:bg-yellow-400/10">
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide pb-2">
          {categories.map((cat) => (
            <button
              ...
              className={`flex items-center gap-2 whitespace-nowrap rounded-full border-2 px-4 py-2 text-sm font-semibold transition-all ${activeCategory === cat.id
        ...
        <div className="space-y-3">
          {filteredFaqs.length === 0 ? (
            <div className="rounded-3xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-12 text-center">
            ...
            filteredFaqs.map((faq, idx) => (
              <div
                key={idx}
                className="overflow-hidden rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 transition-all hover:shadow-lg"
              >
                <button
                ...
                >
                  ...
                  <svg
                    className={`h-5 w-5 flex-shrink-0 text-gray-600 dark:text-gray-400 transition-transform ${openFaq === idx ? "rotate-180" : ""
                      }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                ...
                {openFaq === idx && (
                  <div className="border-t-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-6">
